...
class Conv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, k):
        super().__init__()
        self.conv = nn.Identity()  # 空实现
    
    def forward(self, x):
        return x  

class SequenceAttention_CGA(nn.Module):
    def __init__(self):
        super(SequenceAttention_CGA, self).__init__()
