...
class ProteinRankNet(nn.Module):
    def __init__(self, input_shape):
        ...
        # 3D卷积层
        self.conv3d_1 = DepthwiseSeparableConv3D(in_channels=1, out_channels=32, kernel_size=(3, 3, 3), stride=(3, 3, 3), padding=1)
        self.conv3d_bn1 = nn.BatchNorm3d(32)

        # 添加更多的3D卷积层
        self.conv3d_2 = DepthwiseSeparableConv3D(32, 64, kernel_size=(3, 3, 3), stride=(3, 3, 3), padding=1)
        self.conv3d_bn2 = nn.BatchNorm3d(64)

        # 2D卷积层
        self.conv2d_1 = DepthwiseSeparableConv2D(64, 128, kernel_size=(3, 3), stride=(3, 3), padding=1)
        self.conv2d_bn1 = nn.BatchNorm2d(128)

        self.conv2d_2 = DepthwiseSeparableConv2D(128, 256, kernel_size=(3, 3), stride=(3, 3), padding=1)
